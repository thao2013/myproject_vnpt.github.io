...
<head>
    ...
    <script src="../../assets/js/auth-title-job.js"></script>	
...
<div id="wrapper">
        ...
        <div id="content">
            ...
            ?>
            <p>PHÂN QUYỀN THEO CHỨC DANH NHÂN VIÊN</p>
            <div class="choose-pro">
                <p>Chọn một chức danh và một chương trình để thực hiện phân quyền</p>
                <div class="content-choose-pro">
                    <div style="display: grid; width: 40%;">
                        <label for="" class="title">Chức danh nhân viên</label>
                    ...
                    <div style="width: 50%;">
                        <div class="btn-save-cancel">
                            <select name="" id="unit-type" style="margin: 0;">
                                <option value="" selected disabled>Chọn loại đơn vị</option>
    ...
    <div id="div-choose-group">
        <div class="form-choose-group">
            ...
            <p class="title-choose">Chọn chức danh</p>
            <div class="div-table">
                <table id="table-group">
                    ...
                    <?php
                    $stid=oci_parse($conn, "SELECT * FROM CHUCDANH ORDER BY ID_CD ASC");
                    oci_execute($stid);
